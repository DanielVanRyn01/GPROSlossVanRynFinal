...
const char colVals[defaultRstr] =
{ 
...
void getRowColumn(int answ[2], int rowRestrict = defaultRstr, int colRestrict = defaultRstr); //answ is changed so 0 is row and 1 is column
